...
import { Portfolio, PortfolioSimulationData } from "../interface/dto/portfolio";
import { BacktestingRes } from "../interface/dto/backtesting";
import { ETFTimeSeriesDTO } from "../interface/dto/etf";
  ...
  export const getCommonDates = (pricesInfo: ETFTimeSeriesDTO[]): string[] => {
    ...
    const dateResult = Array.from(tmpMap.entries())
      .filter(([key, val]) => {
        console.log("ketval", key, val, count);
