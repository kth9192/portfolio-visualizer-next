...
function PortfolioList() {
  ...
  const [expendedItem, setExpendedItem] = useState<string | null>(null);

  const handleCreatePortfolio = () => {
    router.push("/backtesting");
  };

  const handleAnalyzePanelOpen = (portfolioId: string) => {
    setExpendedItem(expendedItem === portfolioId ? null : portfolioId);
  };

  useEffect(() => {
    console.log("현재 아이템", expendedItem);
  }, [expendedItem]);
